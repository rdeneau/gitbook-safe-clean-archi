...
- [Fantomas](https://fsprojects.github.io/fantomas/) — F# code formatter
  ([configuration reference](https://fsprojects.github.io/fantomas/docs/end-users/Configuration.html))
...
- [Stryker](https://stryker-mutator.io) — Mutation testing
  ([.NET documentation](https://learn.microsoft.com/en-us/dotnet/core/testing/mutation-testing))
